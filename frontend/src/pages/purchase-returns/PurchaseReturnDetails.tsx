...
export function PurchaseReturnDetails() {
  ...
  return (
    <PageTemplate
      ...
      subtitle={`Supplier: ${ret.supplier.companyName} | Ref PO: ${ret.purchaseOrder.poNumber}`}
      breadcrumbs={[
        { label: 'Purchase Returns', href: '/purchase-returns' },
        { label: ret.returnNumber, href: `/purchase-returns/${ret.id}` },
      ]}
      actions={
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-sm">
            ...
            <CardContent className="space-y-4 text-sm">
              ...
              {ret.notes && (
                <div>
                  <span className="font-semibold block text-muted-foreground mb-1">Logistics Notes</span>
